    ...
    <>
      ...
      <div className="sub-title">
        <p className="path-container">
          {" "}
          <span className="path" onClick={() => MoreInfoComponent("/Lawyer")}>
            Home
          </span>{" "}
          /{" "}
          <span
            className="path"
            onClick={() => MoreInfoComponent("/Lawyer/blog")}
          >
            Blogs
          </span>{" "}
      ...
      <section className="container-fluid card-blog-outer">
        <div className="row">
          <div className="col-md-12">
            <div className="More_img main-blog-card">
              <img
        ...
        <div className="row">
          <div className="col-md-12 More_Content">
            <p>
